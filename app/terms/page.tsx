  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-6 py-14">
      ...
      <div className="mt-8 flex flex-col gap-7 text-[14.5px] leading-relaxed">
        <section>
          <h2 className="mb-2 text-[15px] font-bold">1. Acceptance</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-[15px] font-bold">2. What the App does</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-[15px] font-bold">3. Your content</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-[15px] font-bold">4. Accuracy</h2>
          <p>
            ...
            before confirming; the App won&rsquo;t add anything to your calendar
            without that confirmation, and you can edit or remove any event first.
          </p>
        </section>

        <section>
          <h2 className="mb-2 text-[15px] font-bold">5. No warranty</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-[15px] font-bold">6. Limitation of liability</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-[15px] font-bold">7. Changes</h2>
          <p>We may update these terms or the App at any time.</p>
        </section>

        <section>
          <h2 className="mb-2 text-[15px] font-bold">8. Contact</h2>
          <p>
